        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SchooleQuizId = table.Column<int>(type: "int", nullable: false),
                    SchoolQuizId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizPosts_SchoolQuizzes_SchoolQuizId",
                        column: x => x.SchoolQuizId,
                        principalTable: "SchoolQuizzes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizPosts_SchoolQuizId",
                table: "QuizPosts",
                column: "SchoolQuizId");
